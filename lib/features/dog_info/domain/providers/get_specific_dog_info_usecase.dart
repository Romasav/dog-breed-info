...
import '../usecases/get_specific_dog_info.dart';

part 'get_specific_dog_info_usecase.g.dart';

@Riverpod(dependencies: [dogInfoRepository])
UseCase<DogInfo, Params> getSpecificDogInfoUseCase(
  GetSpecificDogInfoUseCaseRef ref,
) {
  final dogInfoRepository = ref.watch(dogInfoRepositoryProvider);
  return GetSpecificDogInfo(dogInfoRepository);
}
